...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Categries</a> <a href="#" class="current">Edit Categries</a> </div>
    <h1>Edit Categries</h1>
